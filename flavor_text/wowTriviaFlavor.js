 ...
 * to the era the question bank actually covers (vanilla WoW, 1.0-1.12) —
 * Thrall as Warchief of the Horde, Lord Regent Bolvar Fordragon ruling
 * Stormwind in the still-missing King Varian Wrynn's stead — so an answer
 * that's since gone stale reads as "of that age," not as the bot being
 * wrong. The voice only drops back to the Herald's
...
// framing. Always names both Thrall and Bolvar, per that framing's whole
// point. Shown once, regardless of how many questions the session runs.
const wowTriviaIntroLines = () => [
    "The Herald clears his throat, and when he speaks again it is in a booming, guttural voice: \"KZAH! Hear this, ye court — we march back through the mists of time, to the age when THRALL stands Warchief of the Horde, and Lord Regent Bolvar Fordragon holds Stormwind's throne while its king remains lost! Answer true, if ye dare!\"",
    "The Herald's posture shifts, shoulders squaring like a warchief's honor guard, and his voice drops into a low orcish rumble: \"Lok'tar! We journey to the days of Thrall's Horde and Lord Regent Bolvar Fordragon's Alliance — a simpler age, and a trickier trivia! Speak thy answer swift, or be left in the dust of history!\"",
    "The Herald plants his staff like a war-standard and bellows in a rough, orcish timbre: \"By the ancestors! Back we go to when Thrall leads the Horde and Lord Regent Bolvar Fordragon rules the Alliance from Stormwind's throne! Prove thy knowledge of that age, mortal!\"",
    "The Herald grins, cracks his knuckles, and lets his voice fall into a gravelly orcish growl: \"Che'senil! The court travels back to the age of Warchief Thrall and Lord Regent Bolvar Fordragon! Speak first, speak true, and claim thy glory!\"",
    "The Herald draws a breath and roars, orc-voiced and proud: \"For the Horde! For the Alliance! For BOTH, this day — we return to when Thrall commands the Horde and Lord Regent Bolvar Fordragon commands the Alliance! Let the trivia of that age begin!\"",
];
